...
namespace Rehber
{
    public partial class Form1 : Form
    {
        ...
        //Data Source=LAPTOP-FB9086OP;Initial Catalog=Rehber;Integrated Security=True

        SqlConnection baglanti = new SqlConnection(@"Data Source=LAPTOP-FB9086OP;Initial Catalog=Rehber;Integrated Security=True");
